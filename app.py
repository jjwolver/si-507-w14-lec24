...
def bball():
    ...
    return render_template("seasons.html", seasons=seasons,sport="Basketball",action="/bball")
...
def fball():
    ...
    return render_template("seasons.html", seasons=seasons, sport="Football", action="/fball")
